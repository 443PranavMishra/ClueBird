"""Exact class folder names from the user's dataset (verified against 200-item count)."""
...
"Black_and_white_Warbler","Black_billed_Cuckoo","Black_capped_Vireo","Black_footed_Albatross","Black_Tern",
"Black_throated_Blue_Warbler","Black_throated_Sparrow","Blue_Grosbeak","Blue_headed_Vireo","Blue_Jay",
...
"Gray_crowned_Rosy_Finch","Gray_Kingbird","Great_Crested_Flycatcher","Great_Grey_Shrike","Green_Jay",
"Green_Kingfisher","Green_tailed_Towhee","Green_Violetear","Groove_billed_Ani","Harris_Sparrow",
...
"Pelagic_Cormorant","Philadelphia_Vireo","Pied_billed_Grebe","Pied_Kingfisher","Pigeon_Guillemot",
...
"Western_Gull","Western_Meadowlark","Western_Wood_Pewee","Whip_poor_Will","White_breasted_Kingfisher",
"White_breasted_Nuthatch","White_crowned_Sparrow","White_eyed_Vireo","White_necked_Raven","White_Pelican",
"White_throated_Sparrow","Wilson_Warbler","Winter_Wren","Worm_eating_Warbler","Yellow_bellied_Flycatcher",
"Yellow_billed_Cuckoo","Yellow_breasted_Chat","Yellow_headed_Blackbird","Yellow_throated_Vireo","Yellow_Warbler",
]

assert len(CLASSES) == 200, f"Expected 200, got {len(CLASSES)}"
assert len(set(CLASSES)) == 200, "Duplicate class names found"
